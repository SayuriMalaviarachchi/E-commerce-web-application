...
import HeroImg from '../assets/womenSection/hero11.png'
import Trouser from '../assets/womenSection/women1.png'
import Tshirt from '../assets/womenSection/women2.png'
      ...
      <div className="bg-[#CAC7BF]">
        <div className="lg:container mx-auto pt-10 pb-12">
          <div className="grid md:grid-cols-12 grid-cols-8 lg:gap-22 gap-10 md:p-0 p-3">
            ...
            <div className="h-20 bg-[#9e9b95]  flex justify-center items-center rounded-b-2xl">Tops</div>
            ...
            <div className="h-20 bg-[#9e9b95] flex justify-center items-center rounded-b-2xl">Pants</div>
            </div>
          </div>
        </div>
      </div>
