    ...
    <div className="bg-[#CAC7BF] min-h-screen grid grid-cols-12 items-center">
      <div className="col-span-10 md:col-span-10  lg:col-span-8  col-start-2 lg:col-start-3 md:col-start-2 h-max bg-white rounded-2xl p-8 md:p-8 grid grid-cols-2 md:grid-cols-10 lg:grid-cols-6 gap-7 mt-4">
        <div className="col-span-2 md:col-span-5 lg:col-span-3">
          <div className="text-[33px] font-bold pb-1 text-[#223531]">Sign Up</div>
          <div className="pb-3">Let's start with some facts about you</div>
          <div className="flex gap-3 pb-3 ">

            <div className="w-full">
              <p className="text-[13px] text-[#78746D]">Firstname</p>
              <input
                className="bg-[#E6E3DB] h-9 rounded-lg p-2 border-[#223531] border-1 outline-0 w-full"
                type="text"            
              />
            </div>
          ...
          <button className="w-full h-9 rounded-lg bg-[#223531] text-white mt-3 active:translate-y-0.5 cursor-pointer hover:bg-[#2c423c]  ">Sign up</button>
          <div className="pt-4 text-sm text-center">Already have an account?<a href=""><u>Login</u></a></div>
        </div >
