    ...
    <div className='bg-[#bdbab1]  pt-9 pb-10'>
      <div className='container mx-auto grid '>
        ...
        <div className='mb-4 col-span-6 col-start-3'>
            ...
            <div>< input  className='bg-[#CAC7BF] border-1 shadow-2xl rounded-lg h-10 w-full' type = 'email'/></div>
        </div>
        ...
        <div className='mb-3 col-span-6 col-start-3'>
            ...
            <div><textarea className='bg-[#CAC7BF] w-full rounded-lg shadow-2xl border-1' name="" id="" rows="8"></textarea></div>
        </div>
